...
<head>   
  ...
  <?php include("../controler/main admin/viewController.php"); ?>
            ...
            <div class="page-content">
               ...
               <!-- START X-NAVIGATION VERTICAL -->
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left">
                </div>
                <!-- END PAGE TITLE -->                
                                        ...
                                        <?php while ($qi=mysqli_fetch_array($qu)) { ?>
			                                ...
			                                <td>          <?php echo $qi['email'];?></td>
                                              ...
                                              <td><?php echo $qi['phone'];?></li></td>
                                                  <td>  <?php echo $qi['about'];?></td>

                                                    
                                          <td> 
										 
										  
										<?php if(!$qi['login_id']==0) {?>
										  <a href="#"  data-toggle="modal" data-value="<?php echo $qi['login_id']; ?>" data-target="#modal_udel" class="btn btn-default btn-rounded btn-condensed btn-sm sub"><span class="fa fa-times-circle"></span></a>
										  <?php }?>
