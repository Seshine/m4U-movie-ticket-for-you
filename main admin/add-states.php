                        ...
                        <div class="col-md-12">
                         ...
                         <label class="col-md-3 control-label">ADD STATE</label>
                                ...
                                <div class="panel-footer">
                                    ...
                                    <input type="submit" class="btn btn-primary pull-right" name="subloc" id="subloc" value="submit"/>
                                </div>
                            </div>
											...
											{ ?>                                        
                                                <tr id="trow_1">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a data-value="<?php echo $p['id'];?>" name="vdelete" class="btn btn-danger btn-rounded btn-condensed btn-sm vdelete" onClick="delete_row('trow_1');"><span class="fa fa-times" name="delete"></span></a>
                                                    </td>
                                                </tr> 
												<?php  } ?>
