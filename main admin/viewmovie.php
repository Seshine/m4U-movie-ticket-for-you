...
<head>        
        ...
        <!-- EOF CSS INCLUDE -->  
	  	<?php include("../controler/main admin/acceptviewmovieController.php");  ?>
		   <?php include("../controler/main admin/viewmovieController.php"); ?>   
      ...
      <!-- START PAGE CONTAINER -->
        <div class="page-container">
         ...
         <li  >
				    ...
				    </li ><li class="xn-openable active" >
					<a href="index.php"><span class="glyphicon glyphicon-th-large"></span><span class="xn-text">MANAGE THEATRE</span></a>  
						...
						<ul>
							...
							<li > <a href="view theatre.php"><span class="fa fa-tasks"></span>VIEW THEATER</a></li>
							<li class="active"> <a href="viewmovie.php"><span class="fa fa-tasks"></span>VIEW MOVIES</a></li>
                          </ul>
				    </li>
                                        ...
                                        <table class="table datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width>THEATRE name</th>
													  <th width>THEATRE User Name</th>
                                            ...
                                            <tbody>                                            
                                             <?php while($e=mysqli_fetch_array($ee)) { ?>
											   <tr> 
                                                    <td class="text-center"><?php echo $e['id']; ?></td>
                                                    <td><strong><?php echo $e['movie_name']; ?></strong></td>
													<td><strong><?php echo $e['name']; ?></strong></td>
                                                   <td><strong><?php echo $e['username']; ?></strong></td> 
                                                 <td>
