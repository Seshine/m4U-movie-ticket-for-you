...
<head>        
      <?php include("../controler/theatre admin/addmovieController.php"); ?>   <!-- META SECTION -->
							 ...
							 <div class="panel-body">
                                <p>                                </div><div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group"> 
											<span class="input-group-addon"><span class="fa fa-pencil"></span></span> <span class="style1"></span>
                                              <input type="text" class="form-control" name="caam" id="caam"/>
                                          </div><span class="help-block"></span>                                        </div>
                                    </div>  
							<div class="panel-body">
                                <p>                                </div><div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group"> 
											<span class="input-group-addon"><span class="fa fa-pencil"></span></span> <span class="style1"></span>
                                              <input type="text" class="form-control" name="duam" id="duam"/>
                                          </div><span class="help-block"></span>										                                        </div>
                                    </div> 
                                    ...
                                    <p>                                </div><div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group"> 
											<span class="input-group-addon"><span class="fa fa-pencil"></span></span> <span class="style1"></span>
                                              <input type="text" class="form-control" name="stam" id="stam"/>
                                          </div><span class="help-block"></span>                                        </div>
                                    </div> 
