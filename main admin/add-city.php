                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">ADD<strong> CITY</strong></h3>
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="selboxs" id="selboxs" required="required">
                               <?php while($da=mysqli_fetch_array($de))  {?>      
                         ...
                         <label class="col-md-3 control-label">ADD CITY DETAILS</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" class="form-control"  name="cityname" id="cityname" required="required"/>
                                                    </div>                                            
                                                  </div>
                                            </div> 
                                ...
                                <div class="panel-footer">
                                    ...
                                    <input type="submit" class="btn btn-primary pull-right" name="addc" id="addc" />
                                </div>
                            </div>
                            </form>
