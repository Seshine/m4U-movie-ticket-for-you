...
<head>    
    ...
    <?php include("../controler/main admin/view-stateController.php"); ?>   
                    ...
                    <li class="xn-profile"   >
                        ...
                        <div class="profile" >
                            <div class="profile-image" >
                                <img src="assets/<?php echo $ques['profilepics'];?>" alt="John Doe" width="200" height="145"/>                            </div>
                    ...
                    <li class="xn-openable" >
				     ...
				     <li class="xn-openable active"  >
						...
						<ul>
                            ...
                            <li  class="active" ><a href="view-state.php"><span class="glyphicon glyphicon-eye-open"></span>SEE STATE</a></li>
                          </ul>
				    </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">ADD<strong> STATE</strong></h3>
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <form method="post" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                  <select class="form-control select" name="selbox" id="selbox" value="selbox">
										...
										<input type="submit" class="btn btn-primary pull-right" name="sub" id="sub" value="submit"/>	            
                                        ...
                                        <table class="table table-bordered table-striped table-actions">
											...
											{ ?>                                        
                                                <tr id="trow_1">
                                                    ...
                                                    <td>24/09/2014</td>
													<td><span class="label label-success"><a href="">ADD CITY</a></span></td>
                                                    <td>
                                                        <a href="editstate.php?id=<?php echo $p['id'];?>&country=<?php echo $p['country_id'];?> class="btn btn-default btn-rounded btn-condensed btn-sm"><span class="fa fa-pencil"></span></a>
