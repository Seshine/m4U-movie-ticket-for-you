                ...
                <div class="page-content-wrap" style="background-image:url('img/Red-Material-Design-HD-Wallpaper.jpg')" >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal"   method="post" action="table-state.php" name="addstate" id="addstate">   
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="selbox" id="selbox" value="selbox" required="required">
                         ...
                         <label class="col-md-3 control-label">ADD STATE</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="statename" id="statename" required="required"/>
                                                    </div>                                            
                                                  </div>
                                            </div> 
                                ...
                                <div class="panel-footer">
                                    ...
                                    <input type="submit" class="btn btn-primary pull-right" name="sublos" id="sublos" value="submit"/>
                                </div>
                            </div>
