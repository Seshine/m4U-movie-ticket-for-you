...
<head>        
        ...
        <!-- EOF CSS INCLUDE -->      <?php  include("../controler/main admin/changeprofilepicController.php"); ?>                                    
    </head>
    <body>
                    ...
                    <li class="xn-profile"   >
                        ...
                        <div class="profile" >
                            <div class="profile-image" >
                                <img src="assets/<?php echo $ques['profilepics'];?>" alt="admine" width="200" height="145"/>                            </div>
