...
<head>     <?php  include("../controler/theatre admin/session/session.php"); ?>    
		...
		<?php include("../controler/theatre admin/addtheatreController.php");  ?>       
			<?php include("../controler/theatre admin/addscreenController.php");  ?> 
                      ...
                      <form method="post">  <!-- CONTACT FORM -->
                        <div class="col-md-4">
                            ...
                            <div class="panel panel-colorful">
                                <div class="panel-body">
                                    <h2>ADD SCREEN</h2>
                                    <p >ADD YOUR SCREEN TYPE</p><br>
                                   
								   <div class="form-group">
                                        <label>SCREEN TYPE</label>
                                         <input type="text" class="form-control" placeholder="SCREEN type" name="mvscreen" id="mvscreen"/>
										
                                    </div>   
                                   
									 <div class="form-group">
                                        <label>SEAT CAPACITY</label>
                                         <input type="number" class="form-control" placeholder="seat avilable" name="mvseat" id="mvseat"/>
                                    </div>    
                                    
                                     <div class="form-group">
                                        <label>AMOUNT/SEAT</label>
                                         <input type="number" class="form-control" placeholder="Amount" name="mvamount" id="mvamount"/>
                                    </div>    
                                                                
                                                                 
                                </div>
                                <div class="panel-footer"> 
                                    <input type="submit" class="btn btn-success pull-right" value="ADD" name="addscreen" id="addscreen"/>
                                </div>
                            </div>
                        </div>
