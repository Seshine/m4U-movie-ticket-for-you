...
<head>   <?php  include("../controler/theatre admin/session/session.php"); ?>
    ...
    <body>
	<?php include("../controler/theatre admin/addshowsController.php"); ?>      
                           ...
                           <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" role="form">                                    
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Starting Time</label>
                                            <div class="col-md-5">
                                                <div class="input-group bootstrap-timepicker">
                                                    <input type="text" name="sttime" id="sttime"  class="form-control timepicker" required="required">
                                                    <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-md-3 control-label">Ending Time</label>
                                            <div class="col-md-5">
                                                <div class="input-group bootstrap-timepicker">
                                                    <input type="text" name="endtime" id="endtime" class="form-control timepicker" required="required">
                                                    <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                       <div class="panel-footer">                                
                                    <button type="submit" id="addshow" name="addshow" class="btn btn-primary pull-right">Save</button>
                                </div>
                                    </form>
                                </div>
                            </div></div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">View Shows</h3>
                                        ...
                                        <table class="table datatable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $p['timefrom'];?></td>
                                                    <td><?php echo $p['timeto'];?></td>
         ...
         <div class="modal animated fadeIn" id="modal_delete_category" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="showcatdelete" name="showcatdelete" method="post" >
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" id="cp_accept">Yes</button>
