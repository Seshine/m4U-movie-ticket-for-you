...
<head>    
 ...
 <?php include("../controler/theatre admin/changeprofilepicController.php"); ?>   
      <?php include("../controler/theatre admin/editmovieController.php"); ?>   <!-- META SECTION -->
        <title>T4U</title>            
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <p>                                </div><div class="form-group">
									    ...
									    <label class="col-md-3 col-xs-12 control-label">MOVEI NAME</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group"> 
											<span class="input-group-addon"><span class="fa fa-pencil"></span></span> <span class="style1"></span>
                                              <input type="text" class="form-control" name="nam" id="nam" value="<?php echo $p['movie_name']; ?>"/>
					 ...
					 <div class="panel-body">
                                <p>                                </div><div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group"> 
											<span class="input-group-addon"><span class="fa fa-pencil"></span></span> <span class="style1"></span>
                                              <input type="text" class="form-control" name="dam"  id="dam" value="<?php echo $p['director']; ?>" />
                                          </div><span class="help-block"></span>                                        </div>
                                    </div>
							 ...
							 <div class="panel-body">
                                <p>                                </div><div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">PRODUCEOR</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group"> 
											<span class="input-group-addon"><span class="fa fa-pencil"></span></span> <span class="style1"></span>
                                              <input type="text" class="form-control" name="pam" id="pam" value="<?php echo $p['producer']; ?>"/>
                                          </div><span class="help-block"></span>                                        </div>
                                    </div>  
							 ...
							 <div class="panel-body">
                                <p>                                </div><div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group"> 
											<span class="input-group-addon"><span class="fa fa-pencil"></span></span> <span class="style1"></span>
                                              <input type="text" class="form-control" name="caam" id="caam" value="<?php echo $p['casting']; ?>"/>
                                          </div><span class="help-block"></span>                                        </div>
                                    </div>  
							<div class="panel-body">
                                <p>                                </div><div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group"> 
											<span class="input-group-addon"><span class="fa fa-pencil"></span></span> <span class="style1"></span>
                                              <input type="text" class="form-control" name="duam" id="duam" value="<?php echo $p['durations']; ?>"/>
                                          </div><span class="help-block"></span>										                                        </div>
                                    </div> 
                                    ...
                                    <p>                                </div><div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group"> 
											<span class="input-group-addon"><span class="fa fa-pencil"></span></span> <span class="style1"></span>
                                              <input type="text" class="form-control" name="stam" id="stam" value="<?php echo $p['story']; ?>"/>
                                          </div><span class="help-block"></span>                                        </div>
                                    </div> 
									 
									 <div class="panel-footer">
                                    <button class="btn btn-default">Clear Form</button>                                    
                                   <div class="col-md-6 col-xs-12"> <input type="submit" class="btn btn-primary pull-right" value="Update" name="usam" id="usam"/>
                                </div>
                            </div>
							</div>
                            </form>				
