...
<head>   <?php  include("../controler/theatre admin/session/session.php"); ?>
    ...
    <body>
    <?php include("../controler/theatre admin/addscreensController.php"); ?>      
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" role="form">                                    
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" id="catname" name="catname" class="form-control" required="required">
                                            </div>
                                        </div>
                                      <div class="form-group">
                                            <label class="col-md-3 control-label">Number of Seats</label>
                                            <div class="col-md-5">
                                                <input type="text" id="noseats" name="noseats" class="form-control" required="required">
                                            </div>
                                        </div>
										 <div class="form-group">
										 
                                        <label class="col-md-3 control-label" >AMOUNT/SEAT</label>
										  <div class="col-md-5">
                                         <input type="number" class="form-control" placeholder="Amount" name="mvamount" id="mvamount" required="required"/>
                                   </div>
								    </div>    
                                                
										
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">AC/Non AC</label>
                                            <div class="col-md-5">
                                                <select class="form-control" id="sctype" name="sctype" required="">
                                    ...
                                    <button type="submit" id="addscreen" name="addscreen" class="btn btn-primary pull-right">Save</button>
                                </div>
                                    </form>
                                </div>
                            </div></div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table datatable">
                                            ...
                                            <tbody>
                                                <?php 
                                                $i=1;
                                                while($p=mysqli_fetch_array($showcat)) { ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo $p['screenname'];?></td>
                                                    <td><?php echo $p['seats'];?></td>
													 <td><?php echo $p['amount'];?>Rupees</td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="screencatdelete" name="screencatdelete" class="btn btn-success" >Yes</button>
