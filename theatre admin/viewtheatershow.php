...
<head>   <?php  include("../controler/theatre admin/session/session.php"); ?>
    ...
    <body>
    <?php include("../controler/theatre admin/viewtheatershowsController.php"); ?>      
           ...
           <?php include('menu.php'); ?>
            <div class="page-content">
              ...
              <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="#">HOME</a></li>
                    <li><a href="#">VIEW THEATER SHOWS</a></li>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table datatable">
                                            ...
                                            <tbody>
                                                <?php 
                                                $i=1;
                                                while($p=mysqli_fetch_array($shows)) { ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="smallModalHead">Delete Theater Show</h4>
                    </div>                    
                    <form  method="post" >
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="theatershowdelete" name="theatershowdelete" class="btn btn-success" >Yes</button>
