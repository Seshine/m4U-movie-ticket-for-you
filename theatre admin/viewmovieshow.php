...
<head>     
 ...
 <?php include("../controler/theatre admin/viewmovieshowController.php");  ?>    
            ...
            <div class="page-content">
               ...
               <!-- START X-NAVIGATION VERTICAL -->
                ...
                <ul class="breadcrumb">
                    <li><a href="#">HOME</a></li>                    
                    <li >VIEW MOVIES</li>
                     <li class="active">VIEW MOVIESHOW</li>
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> VIEW MOVIE SHOWS</h2>
                </div>
                <!-- END PAGE TITLE -->                
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php while($qt=mysqli_fetch_array($darth))  { ?>  
                                       <tr>
									   <td><?php echo $qt['id']; ?></td>
                               
								 
								 <td><?php echo $qt['name']; ?></td>
							
								   <td><?php echo $qt['movie_name']; ?></td>
                                   <td><?php echo $qt['showtypeid']; ?></td>
								  	    <td>
													
                                                       
                                                        <a data-value="<?php echo $qt['id'];?>" name="vdelete" class="btn btn-danger btn-rounded btn-condensed btn-sm vdelete" onClick="delete_row();"><span class="fa fa-times" name="delete"></span></a>
                                                    </td>											
