...
<head>   <?php  include("../controler/theatre admin/session/session.php"); ?> <?php include("../controler/theatre admin/changeprofilepicController.php"); ?>
        <!-- META SECTION -->
        <title>T4U</title>            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
              ...
              <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="#">HOME</a></li>
                    <li><a href="#">REQUEST THEATRE</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
										 <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="cat" id="cat" required="required">
                                        ...
                                        <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" class="form-control" name="coat" id="coat" required="required"/>
                                                    </div>                                            
