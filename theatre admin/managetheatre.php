...
<!-- Mirrored from aqvatarius.com/themes/atlant_v1_5/html/form-layouts-tabbed.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Jan 2015 05:26:28 GMT -->
<head>        
        <!-- META SECTION -->
                                             ...
                                             <?php while($e=mysqli_fetch_array($de)) { ?>
											   <tr> 
                                                  ...
                                                  <td><strong><?php echo $e['address']; ?></strong></td>
                                                    <td>24/09/2014</td>
													<td><span class="label label-success"><a href="">ADD movei</a></span></td>
                                                    <td>
                                                        ...
                                                        <button class="btn btn-danger btn-rounded btn-condensed btn-sm" onClick="delete_row('');"><span class="fa fa-times"></span></button>
                                                    </td>
                                                </tr>
                                             <?php } ?>
                                            </tbody>
