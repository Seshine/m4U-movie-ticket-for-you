                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">theatre tables</h3>
                                </div>
                                        ...
                                        <table class="table table-bordered table-striped table-actions">
                                            ...
                                            <tbody>                                            
                                                <tr id="trow_1">
                                                    ...
                                                    <td><strong>movei</strong></td>
                                                    
                                                  
                                                    <td>24/09/2014</td>
													<td><span class="label label-success"><a href="form.php">ADD movei</a></span></td>
                                                    <td>
                                                ...
                                                <tr id="trow_2">
                                                    ...
                                                    <td><span class="label label-success"><a href="table-state.php">ADD movei</a></span></td>
                                                    <td>
                                                        <button class="btn btn-default btn-rounded btn-condensed btn-sm"><span class="fa fa-pencil"></span></button>
                                                ...
                                                <tr id="trow_3">
                                                    ...
                                                    <td><strong>movei</strong></td> <td>22/09/2014</td>
                                                    <td><span class="label label-success"><a href="table-state.php">ADD movei</a></span></td>
