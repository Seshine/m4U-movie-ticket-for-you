        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <ul class="xn-openable">
                        <a href="#"><span class="fa fa-cogs"></span> <span class="xn-text">Add moveis & theaters</span></a>                        
                          ...
                          <li class="xn-openable">
                                <a href="table-basic.php"><span class="fa fa-tasks"></span> see THEATER</a>                    </li>   
                            </li>
                                ...
                                <div class="panel-body">
								 ...
								 <div class="panel-body">
                                    <p class="style1">                                </div>
                                      ...
                                      <div class="container"  style="background-color:#00D3FF">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
											...
											<span class="input-group-addon"><span class="fa fa-pencil"></span></span> <span class="style1"></span>
                                              <input type="text" class="form-control"/>
													...
													<div class="panel-body">
                                    <p>                                </div><div class="form-group">
                                         <label class="col-md-3 control-label">movei images</label>
                                                <div class="col-md-9">                                                                                                                                        
