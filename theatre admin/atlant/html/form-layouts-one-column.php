    ...
    <body>
        ...
        <div class="page-container">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-profile">
                        ...
                        <a href="index.php"><span class="fa fa-cogs"></span> <span class="xn-text">home</span></a>                                                                        
                            ...
                            <li class="xn-openable" >
                                <a href="form-layouts-one-column.php"><span class="fa fa-tasks"></span> ADD THEATER</a>                    </li>   
                            </li>
                          <li class="xn-openable">
                                <a href="table-basic.php" class="active"><span class="fa fa-tasks"></span> see THEATER</a>                    </li>   
                            </li>
                   
                    <li class="xn-openable">
                        <a href="form.php">ADD MOVEIS</a></li>
                            
                         <li class="xn-openable">
                                <a href="table1-basic.php"><span class="fa fa-tasks"></span> SEE MOVIES</a>                    </li>   
                            </li>
                    </li>                    
            ...
            <div class="page-content">
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb" style="background-color:#00D3FFa">
                    <li><a href="#">Home</a></li>
                    <li><a href="#">ADD THEATERS</a></li>
                                    </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE CONTENT WRAPPER -->
				 <section class="section clearfix" style="background-color:#00D3FFa"  >
                <div class="page-content-wrap" style="background-color:#00D3FFa">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>ADD THEATERS</strong> </h3>
                ...
                <div id="fullwidth" class="col-sm-12">
                                ...
                                <p>                                </div><div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                          ...
                                          </div><span class="help-block">ENTER IN CAPUTAL LETTERS</span>                                        </div>
                                    </div>
					 ...
					 <div class="panel-body">
                                <p>                                </div><div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
											...
											<span class="input-group-addon"><span class="fa fa-pencil"></span></span> <span class="style1"></span>
                                              <input type="text" class="form-control"/>
                                          </div><span class="help-block">ONLY IN INDIA AVAILABLE NOW</span>                                        </div>
                                    </div>
							...
							<div class="panel-body">
							 ...
							 <div class="panel-body">
                                    <p>
									 <div class="panel-body">
                                <p>                                </div><div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">THEATER CODE</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group"> 
											<span class="input-group-addon"><span class="fa fa-pencil"></span></span> <span class="style1"></span>
                                              <input type="text" class="form-control"/>
							 ...
							 <div class="panel-body">
                                    ...
                                    <p>
									 <div class="panel-body">
                                    <p>                                </div><div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">PINCODE CODE</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group"> 
											<span class="input-group-addon"><span class="fa fa-pencil"></span></span> <span class="style1"></span>
                                              <input type="text" class="form-control"/>
                                    ...
                                    <p>                                </div><div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group"> 
											<span class="input-group-addon"><span class="fa fa-unlock-alt"></span></span> <span class="style1"></span>
                                ...
                                <div class="panel-footer">
                                    <button class="btn btn-default">Clear Form</button> 
									  <button class="btn btn-default"> <a href="table-basic.php">submit</a></button>                                  
                                </div>
                            </div>
                            </form>
                        </div>
