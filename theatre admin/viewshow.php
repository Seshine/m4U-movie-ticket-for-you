...
<?php include("../controler/theatre admin/viewshowController.php");  ?>    
     <?php include("../controler/theatre admin/showdeleteController.php");  ?> 
        <!-- META SECTION -->
        <title>T4U</title>            
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                 ...
                                 <td><?php echo $qse['name']; ?></td>
								 
								 <td><?php echo $qse['startshow']; ?></td>
								 <td><?php echo $qse['am_pm']; ?></td>
								 <td><?php echo $qse['endshow']; ?></td>
								 <td><?php echo $qse['showdate']; ?></td>
								  	    <td>
