...
<head>   
 ...
 <?php include("../controler/theatre admin/changeprofilepicController.php"); ?>   
   <?php include("../controler/theatre admin/schedulController.php"); ?> 
        <!-- META SECTION -->
        <title>T4U</title>            
                        ...
                        <div class="col-md-12">
                           ...
                           <div class="panel-body">
                                    ...
                                    <td><?php echo $er['address'];?></td>
                                     <td><?php echo $er['name']; $_SESSION['a']=$er['name']; ?></td>
                                      <td>NAME:<?php echo $er['movie_name']; $_SESSION['b']=$er['movie_name'];?>,PRODUCER:<?php echo $er['producer'];?>,DIRECTOR:<?php echo $er['director'];?>,CASTING:<?php echo $er['casting'];?>,STORY:<?php echo $er['story'];?></td>
									  <td><?php $ep=mysqli_fetch_array(mysqli_query($con,"select * from mv_login where id='".$er['login_id']."' ")); echo $ep['username'];?></td>
                                      <td>DATE FROM:<?php echo $er['datefrom'];$_SESSION['e']=$er['datefrom'];?>-DATE TO:<?php echo $er['dateto'];$_SESSION['f']=$er['dateto'];?></td>
                                      <td>SHOWNAME:<?php echo $er['showname'];?>,TIME FROM:<?php echo $er['timefrom'];?>,TIME TO:<?php echo $er['timeto'];?></td>
                                      <td>SCREEN NAME:<?php echo $er['screenname']; $_SESSION['d']=$er['screenname'];?>,SCREEN TYPE:<?php echo $er['sctype'];?>,SCREEN SEAT:<?php echo $er['seats'];?>,AMOUNT<?php echo $er['amount'];?></td>
                                      <td><?php echo $er['noseat']; $_SESSION['c']=$er['noseat'];?></td>
                                       <td><?php echo $er['amount'];$_SESSION['g']=$er['amount'];?></td>
                                      <td>
									 <a href="#"  data-toggle="modal" data-value="<?php echo $er['w']; ?>" data-target="#modal_add_show" class="btn btn-default btn-rounded btn-condensed btn-sm changestatus"><i class="fa fa-plus"></i></a>
									  
									  
									  
									 <a data-toggle="modal" data-value="<?php echo $er['w'];?>" name="vdelete" class="btn btn-danger btn-rounded btn-condensed btn-sm vdelete" data-target="#modal_add_r"><span class="fa fa-times-circle"></span></a></td>
									  </tr>
									  <?php }?> 
        ...
        <div class="modal animated fadeIn" id="modal_add_r" name="modal_add_r" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" id="rejectbooking" name="rejectbooking">Yes</button>
                        <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                    </div>
                     </form>
                </div>
