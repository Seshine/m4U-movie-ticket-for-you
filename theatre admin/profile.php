...
<head>        
 ...
 <?php include("../controler/theatre admin/profileController.php"); ?>
 <?php include("../controler/theatre admin/changepassword.php"); ?>
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-5">
                            ...
                            <div class="panel panel-default">                                
                                <div class="panel-body">
                                    <h3><span class="fa fa-user"></span><?php echo $qu['username'];  ?></h3>
                                ...
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-7">
                                            <input type="text" value="<?php echo $qu['id'];  ?>"  disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-7">
                                            <input type="text" value="<?php echo $qu['username'];  ?>" class="form-control" disabled/>
                                        </div>
                                    </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-7">
                                            <input type="text" value="<?php echo $qu['address'];  ?>" name="address" id="address" class="form-control"/>
                                        </div>
                                    </div>
									<div class="form-group">
