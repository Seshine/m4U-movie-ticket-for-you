...
<head>      <?php include("../controler/user/session/session.php");?>     
        ...
        <!-- END META SECTION -->
         <?php include("../controler/user/changeprofilepicController.php");?>
		  <?php include("../controler/user/changepassword.php");?>    
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-profile">
                        <a href="#" class="profile-mini">
                            <img src="assets/<?php echo $ques['profilepics'];?>"  alt="user"/>                        </a>
                        <div class="profile">
                            <div class="profile-image">
                                <img src="assets/<?php echo $ques['profilepics'];?>"  alt="user" width="200" height="145"/>                            </div>
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-5">
                            ...
                            <div class="panel panel-default">                                
                                <div class="panel-body">
                                    <h3><span class="fa fa-user"></span> <?php echo $_SESSION['useridu'] ?></h3>
                                ...
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-7">
                                            <input type="text" value="<?php echo $_SESSION['useridu'] ?>" class="form-control"/>
                                        </div>
                                    </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body form-group-separated">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-7">
                                            <input type="text" value="<?php echo $qu['username'];?>" class="form-control" name="name" id="name" disabled="disabled"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-7">
                                            <input type="text" value="<?php echo $qu['address'];?>" class="form-control" name="locations" id="locations"/>
                                        </div>
                                    </div>
