      ...
      <!----------------------------------------------slider-------------------------------------------------------->     
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> STATE LISTS</h2>
                </div>
                <!-- END PAGE TITLE -->                
                                        ...
                                        <table class="table table-bordered table-striped table-actions">
                                            ...
                                            <tbody>                                            
                                                ...
                                                <tr id="trow_3">
                                                    ...
                                                    <td><strong>STATE3</strong></td> <td>22/09/2014</td>
                                                    <td><span class="label label-success"><a href="">ADD CITY</a></span></td>
