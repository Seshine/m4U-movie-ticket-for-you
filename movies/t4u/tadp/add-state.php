    ...
    <!-- START PAGE CONTAINER -->
        <div class="page-container" style="background-image:url('img/wood+pattern+texture+4.jpg')">
                ...
                <ul class="x-navigation"  >
                    ...
                    <li >
				     ...
				     <li   >
						...
						<ul>
                            <li ><a href="form-layouts-two-column.html"><span class="glyphicon glyphicon-plus-sign"></span> ADD COUNTRY</a></li>
				     ...
				     <li class="active"  >
						...
						<ul>
                            <li class="active" ><a href="form-layouts-two-column.php"><span class="glyphicon glyphicon-plus-sign"></span> ADD STATE</a> </li>
         ...
         <li >
						...
						<ul>
                            <li><a href=""><span class="glyphicon glyphicon-plus-sign"></span> ADD CITY</a></li>
                            <li><a href=""><span class="glyphicon glyphicon-eye-open"></span>SEE CITY</a></li>
                          </ul>
				    </li>
                ...
                <div class="page-content-wrap" style="background-image:url('img/Red-Material-Design-HD-Wallpaper.jpg')" >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                         ...
                         <label class="col-md-3 control-label">ADD STATE DETAILS</label>
                                                <div class="col-md-9">                                            
                                ...
                                <div class="panel-footer">
                                    ...
                                    <button class="btn btn-primary pull-right"><a href="table-state.php">Submit</a></button>
