        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-profile">
                        ...
                        <div class="profile">
                            <div class="profile-image">
                                <img src="assets/images/users/user4.jpg" alt="John Doe" width="200" height="145"/>                            </div>
                    ...
                    <li class="active">
                        <a href="index.html"><span class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a>                    </li>
                    <li><a href="http://aqvatarius.com/themes/atlant_v1_5/front-end/" target="_blank"><span class="fa fa-star"></span> <span class="xn-text">Front-End Template</span></a></li>
                    ...
                    <li>
                        <a href="maps.html"><span class="fa fa-map-marker"></span> <span class="xn-text">Maps</span></a>                    </li>                    
                    <li class="xn-openable">
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap" style="background-color:#FF3300">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-default widget-carousel" >
                                ...
                                <div class="widget-controls">                                
                                    <a href="#" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="Remove Widget"><span class="fa fa-times"></span></a>                                </div>                             
                            </div>         
                            <!-- END WIDGET SLIDER -->
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row" >
                        <div class="col-md-8" >
                            ...
                            <!-- START SALES BLOCK -->
                            <div class="panel panel-default" style="background-color:#990000">
                                <div class="panel-heading" style="background-color:#990000" >
                                    <div class="panel-title-box">
                                        <h3>Theatre register</h3>
                                        <span>Theatre register under your control</span>                                    </div>                                     
                                ...
                                <div class="panel-body">                                    
                                    <div class="row stacked">
                                        <div class="col-md-4">                                            
                                            ...
                                            <div class="progress-list">                                               
                                                <div class="pull-left"><strong>Registered</strong></div>
                                            ...
                                            <div class="progress-list">                                               
                                                <div class="pull-left"><strong class="text-danger">Delete Theatres</strong></div>
                                            ...
                                            <div class="progress-list">                                               
                                                <div class="pull-left"><strong class="text-warning">Status Today</strong></div>
                                        ...
                                        <div class="col-md-8" style="background-color:#990000">
