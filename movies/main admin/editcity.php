...
<head>        
		...
		<?php include("../controler/main admin/editcityController.php"); ?>     
        ...
        <div class="page-container" style="background-image:url('img/wood+pattern+texture+4.jpg')">
                ...
                <ul class="x-navigation"  >
                    ...
                    <li class="xn-openable" >
                     ...
                     <li class="xn-openable active"  >
						...
						<ul>
                            <li class="active"><a href="add-city.php"><span class="glyphicon glyphicon-plus-sign"></span> ADD CITY</a></li>
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">CITY</a></li>
                    <li><a href="table-city.php">VIEW CITY</a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">EDIT<strong> CITY</strong></h3>
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Select SATTE</label>
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="selboxs" id="selboxs">
                                                <?php while($da=mysqli_fetch_array($da)) {?>        
												<option><?php  echo $da['state_name'];?></option>
                                                   <?php } ?>     
                                                    </select>
                                                    <span class="help-block">List of STATES</span>                                                </div>
                                            </div>
											<br><br><br>
                         ...
                         <label class="col-md-3 control-label">EDIT CITY </label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" class="form-control"  name="cityname" id="cityname" 
														value="<?php echo $ps['city_name']; ?>"/>
                                                    </div>                                            
                                                  </div>
                                            </div> 
                                ...
                                <div class="panel-footer">
                                    ...
                                    <input type="submit" class="btn btn-primary pull-right" name="subloci" id="subloci"  value="update"/>
                                </div>
                            </div>
                            </form>
                        </div>
