<?php include("../controler/main admin/location-deleteController.php") ?>
                    ...
                    <li class="xn-openable">
				     ...
				     <li class="xn-openable active" >
						...
						<ul  >
                            ...
                            <li class="active"><a href="table-basic.php"><span class="glyphicon glyphicon-eye-open"></span>SEE COUNTRY</a></li>
                          </ul>
				    </li>
      ...
      <!----------------------------------------------slider-------------------------------------------------------->     
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">VIEW COUTRY</li>
                </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> COUNTRY LISTS</h2>
                </div>
                <!-- END PAGE TITLE -->                
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">COUNTRY tables</h3>
                                </div>
...
<div class="alert alert-danger" role="alert">
                                <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                                <strong>Error!</strong> Country already existing.
                            </div>
 <?php  }
}
 ?>
                                        ...
                                        <table class="table table-bordered table-striped table-actions">
											...
											<?php  while($p=mysqli_fetch_array($d)) 
                                                ...
                                                <tr id="trow_1">
                                                    ...
                                                    <td><strong> <?php echo $p['country_name'];?> </strong></td>
                                                    
                                                  
                                                    <td><?php echo $p['created_at']; ?></td>
													<td><span class="label label-success"><a href="table-state.php">ADD movies</a></span></td>
                                                    <td>
                                                        <a href="editcountry.php?id=<?php echo $p['id'];?>" class="btn btn-default btn-rounded btn-condensed btn-sm"><span class="fa fa-pencil"></span></a>
