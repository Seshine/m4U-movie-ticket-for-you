...
<head>        
        ...
        <!-- END META SECTION -->
        <?php include("../controler/main admin/city-entryController.php"); ?>  
		  <?php include("../controler/main admin/city-deleteController.php"); ?>  
        <!-- CSS INCLUDE -->        
                    ...
                    <li class="xn-profile"   >
                        ...
                        <div class="profile" >
                            <div class="profile-image" >
                                <img src="img/30000668.jpg" alt="admin" width="200" height="145"/>                            </div>
                    ...
                    <li class="xn-openable"   >
                     ...
                     <li class="xn-openable active"   >
						...
						<ul>
                            ...
                            <li class="active"><a href="table-city.php"><span class="glyphicon glyphicon-eye-open"></span>SEE CITY</a></li>
                          </ul>
				    </li>
      <li class="xn-openable">
      ...
      <!----------------------------------------------slider-------------------------------------------------------->     
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> CITY LISTS</h2>
                </div>
                <!-- END PAGE TITLE -->                
...
<div class="alert alert-danger" role="alert">
                                <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                                <strong>Error!</strong> City is already existing.
                            </div>
 <?php  }
}
 ?>
                                <div class="panel-heading">
                                    <h3 class="panel-title">CITY tables</h3>
                                </div>
                                ...
                                <div class="panel-body panel-body-table">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-actions">
                                            ...
                                            <tbody>   
											<?php while($p=mysqli_fetch_array($das))  {?>
                                                <tr >
                                                    <td class="text-center"><?php echo $p['id'];  ?></td>
													<td><strong><?php echo $p['city_name'];  ?></strong></td>
													<td><?php echo $p['state_name'];  ?></td>
													<td class="text-center"><?php echo $p['country_name'];  ?></td>
													
                                                    
                                                   <td><?php echo $p['created_at'];  ?></td>
													<!--span class="label label-success"><a href="">ADD CITY</a></span></td-->
                                                    <td>
                                                     <a href="editcity.php?id=<?php echo $p['id'];?>" class="btn btn-default btn-rounded btn-condensed btn-sm"><span class="fa fa-pencil"></span></a>
                ...
                <div class="mb-middle">
                    ...
                    <div class="mb-footer">
                        <div class="pull-right">
                            <input type="submit" class="btn btn-success btn-lg mb-control-yes" name="cidelete" id="cidelete" value="yes"/>
