...
<head>        
	...
	<body>
	<?php include("../controler/main admin/editcountryController.php"); ?>
         ...
         <li>
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="table-basic.php">VIEW COUNTRY</a></li>
                         ...
                         <label class="col-md-3 control-label">Country Name</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="countryname" id="countryname" value="<?php echo $p['country_name'];?>"/>
                                                    </div>                                            
                                                  </div>
                                            </div> 
                                ...
                                <div class="panel-footer">
                                    ...
                                    <input type="submit" name="ucountry" id="ucountry" class="btn btn-primary pull-right" value="Update"/>
