...
<head>
    ...
    <![endif]-->
  <?php include("controler/t4u/slideshowController.php"); ?>  
</head>
<body>
<!---topbar--->
...
<center> <a href="index.php" class="btn btn-primary btn-lg border-radius" >REFRESH</a></center>
            ...
            <div class="row">
                ...
                <?php while($p=mysqli_fetch_array($qu)) {?>
                    <div class="mini-desti row">
                        <div class="col-md-4">
                            <img src="posters/small/<?php echo $p['smallposter'];?>" alt="" width="960" height="800" class="img-responsive">                        </div>
                        <!-- end col -->
                        <div class="col-md-8">
                            <div class="mini-desti-title">
                                <div class="pull-left">
                                  <a href="page.php?id=<?php echo $p['id'];?>"><?php echo $p['movie_name'];?></a>
                                    <span class="rating">
    ...
    <section class="nopadding clearfix">
        <div class="owl-fullwidth">
            <div class="owl-item-full"><img src="posters/big/<?php echo $ps['bigposter2'];?>" alt="" width="1184" height="540" /></div>
            <div class="owl-item-full"><img src="posters/big/<?php echo $ps['bigposter3'];?>" alt="" width="1184" height="540" /></div>
        </div><!-- end container -->
    </section><!-- end section -->
