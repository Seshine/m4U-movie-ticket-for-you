                            ...
                            <div class="post-wrapper row clearfix">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form  method="post">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="password" class="form-control" id="inputPassword" name="inputPassword" placeholder="retype-Password">
                                        </div>
                                        ...
                                        <div class="col-sm-10">
                                           <label>Male</label> <input type="radio"   name="s" value="0">
											<label>|female</label><input type="radio"    name="s" value="1">
                                        </div>
