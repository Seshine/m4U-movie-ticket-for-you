...
{
$cat=$_POST['cat'];
$qu="select id from mv_city where city_name='".$cat."'";
...
$qu="update mv_theatre set  city_id='".$qus['id']."', name='".$nat."', address='".$aat."' , pincode='".$pat." ',phone_number='".$coat."',created_at='".$created_at."' ,status='0' where id='".$_REQUEST['id']."'";
$qu=mysqli_query($con,$qu);
if($qu)
{
?>
