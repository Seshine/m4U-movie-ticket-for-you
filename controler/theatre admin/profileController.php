<?php 
 ...
 $qu="select * from mv_theatreregistrations where username='".$_SESSION['userid']."' ";
 ...
 $qe="select id from mv_login where username='".$_SESSION['userid']."' ";
  ...
  {
  $qu="update mv_theatreregistrations set login_id='".$qe['id']."', email='".$_POST['email']."',address='".$_POST['address']."',phone='".$_POST['phone']."' ,about='".$_POST['about']."' 
